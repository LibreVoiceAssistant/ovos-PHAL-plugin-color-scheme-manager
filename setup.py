...
PLUGIN_ENTRY_POINT = 'ovos-PHAL-plugin-color-scheme-manager=ovos_PHAL_plugin_color_scheme_manager:ColorSchemeManager'
setup(
    ...
    license='Apache-2.0',
    packages=['ovos_PHAL_plugin_color_scheme_manager'],
    package_data={'': package_files('ovos_PHAL_plugin_color_scheme_manager')},
